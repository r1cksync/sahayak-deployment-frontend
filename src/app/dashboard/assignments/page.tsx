...
export default function AssignmentsPage() {
  ...
  const getStatusBadge = (assignment: any) => {
    ...
    const userSubmission = assignment.userSubmission || assignment.submissions?.find((sub: any) => sub.student._id === user?.id)
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              {userSubmission.grade !== undefined && userSubmission.grade !== null && (
                                <Badge variant="default">
                                  {typeof userSubmission.grade === 'object' 
                                    ? userSubmission.grade.points || userSubmission.grade.percentage || 0
